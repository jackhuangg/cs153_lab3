...
80100394:	e8 b7 02 00 00       	call   80100650 <cprintf>
  cprintf("\n");
80100399:	c7 04 24 27 78 10 80 	movl   $0x80107827,(%esp)
...
80100c20:	e8 4b 1f 00 00       	call   80102b70 <end_op>
    cprintf("exec: fail\n");
80100c25:	c7 04 24 a1 6e 10 80 	movl   $0x80106ea1,(%esp)
...
80100c7d:	89 95 60 ff ff ff    	mov    %edx,-0xa0(%ebp)
  if (copyout(pgdir, sp, ustack, (3 + argc + 1) * 4) < 0)
80100c83:	e8 88 60 00 00       	call   80106d10 <copyout>
...
80100d08:	e8 13 59 00 00       	call   80106620 <switchuvm>
  freevm(oldpgdir);
80100d0d:	89 34 24             	mov    %esi,(%esp)
80100d10:	e8 8b 5c 00 00       	call   801069a0 <freevm>
  return 0;
...
80102e35:	e8 66 3f 00 00       	call   80106da0 <shminit>
  tvinit();        // trap vectors
...
801039a5:	e8 76 2c 00 00       	call   80106620 <switchuvm>
...
801039c0:	e8 3b 2c 00 00       	call   80106600 <switchkvm>
      switchkvm();
...
80103d28:	e8 73 2c 00 00       	call   801069a0 <freevm>
...
80103e78:	c7 04 24 27 78 10 80 	movl   $0x80107827,(%esp)
...
80105209:	e8 f2 1b 00 00       	call   80106e00 <shm_open>
}
8010520e:	c9                   	leave  
8010520f:	c3                   	ret    
    return -1;
...
80105243:	e8 c8 1b 00 00       	call   80106e10 <shm_close>
}
80105248:	c9                   	leave  
80105249:	c3                   	ret    
...
80105512:	0f 84 00 02 00 00    	je     80105718 <trap+0x218>
    if (myproc()->killed)
      exit();
    return;
  }
...
80105520:	ff 24 85 a8 76 10 80 	jmp    *-0x7fef8958(,%eax,4)
80105527:	90                   	nop
    }
    break;
...
8010552f:	90                   	nop
80105530:	0f 84 70 02 00 00    	je     801057a6 <trap+0x2a6>
80105536:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
8010553a:	0f 84 66 02 00 00    	je     801057a6 <trap+0x2a6>
...
80105593:	c7 04 24 64 76 10 80 	movl   $0x80107664,(%esp)
...
801055fb:	0f 84 48 01 00 00    	je     80105749 <trap+0x249>
    exit();
}
...
80105640:	0f 20 d0             	mov    %cr2,%eax
    if (rcr2() > KERNBASE - 1)
80105643:	85 c0                	test   %eax,%eax
80105645:	0f 88 45 01 00 00    	js     80105790 <trap+0x290>
8010564b:	0f 20 d7             	mov    %cr2,%edi
8010564e:	0f 20 d6             	mov    %cr2,%esi
    if (allocuvm(myproc()->pgdir, PGROUNDDOWN(rcr2()), PGROUNDDOWN(rcr2()) + PGSIZE) != 0)
80105651:	e8 3a e0 ff ff       	call   80103690 <myproc>
80105656:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
8010565c:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
80105662:	81 c7 00 10 00 00    	add    $0x1000,%edi
80105668:	89 7c 24 08          	mov    %edi,0x8(%esp)
8010566c:	89 74 24 04          	mov    %esi,0x4(%esp)
80105670:	8b 40 04             	mov    0x4(%eax),%eax
80105673:	89 04 24             	mov    %eax,(%esp)
80105676:	e8 05 12 00 00       	call   80106880 <allocuvm>
8010567b:	85 c0                	test   %eax,%eax
8010567d:	0f 84 2d ff ff ff    	je     801055b0 <trap+0xb0>
      myproc()->pages++;
80105683:	e8 08 e0 ff ff       	call   80103690 <myproc>
80105688:	83 40 7c 01          	addl   $0x1,0x7c(%eax)
8010568c:	e9 1f ff ff ff       	jmp    801055b0 <trap+0xb0>
80105691:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if (cpuid() == 0)
80105698:	e8 d3 df ff ff       	call   80103670 <cpuid>
8010569d:	85 c0                	test   %eax,%eax
8010569f:	90                   	nop
801056a0:	0f 84 ba 00 00 00    	je     80105760 <trap+0x260>
    lapiceoi();
801056a6:	e8 c5 d0 ff ff       	call   80102770 <lapiceoi>
801056ab:	90                   	nop
801056ac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    break;
801056b0:	e9 fb fe ff ff       	jmp    801055b0 <trap+0xb0>
...
801056c5:	e8 a6 d0 ff ff       	call   80102770 <lapiceoi>
    break;
801056ca:	e9 e1 fe ff ff       	jmp    801055b0 <trap+0xb0>
801056cf:	90                   	nop
    uartintr();
...
80105704:	e8 67 d0 ff ff       	call   80102770 <lapiceoi>
    break;
80105709:	e9 a2 fe ff ff       	jmp    801055b0 <trap+0xb0>
8010570e:	66 90                	xchg   %ax,%ax
    ideintr();
80105710:	e8 5b c9 ff ff       	call   80102070 <ideintr>
80105715:	eb 8f                	jmp    801056a6 <trap+0x1a6>
80105717:	90                   	nop
80105718:	90                   	nop
...
8010575d:	eb cd                	jmp    8010572c <trap+0x22c>
8010575f:	90                   	nop
      acquire(&tickslock);
80105760:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105767:	e8 c4 e9 ff ff       	call   80104130 <acquire>
      wakeup(&ticks);
8010576c:	c7 04 24 a0 55 11 80 	movl   $0x801155a0,(%esp)
      ticks++;
80105773:	83 05 a0 55 11 80 01 	addl   $0x1,0x801155a0
      wakeup(&ticks);
8010577a:	e8 01 e6 ff ff       	call   80103d80 <wakeup>
      release(&tickslock);
8010577f:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105786:	e8 95 ea ff ff       	call   80104220 <release>
8010578b:	e9 16 ff ff ff       	jmp    801056a6 <trap+0x1a6>
      cprintf("accessing page that is not allocated/mapped, page fault occured");
80105790:	c7 04 24 f0 75 10 80 	movl   $0x801075f0,(%esp)
80105797:	e8 b4 ae ff ff       	call   80100650 <cprintf>
      exit();
8010579c:	e8 ef e2 ff ff       	call   80103a90 <exit>
801057a1:	e9 a5 fe ff ff       	jmp    8010564b <trap+0x14b>
801057a6:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801057a9:	8b 73 38             	mov    0x38(%ebx),%esi
801057ac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801057b0:	e8 bb de ff ff       	call   80103670 <cpuid>
801057b5:	89 7c 24 10          	mov    %edi,0x10(%esp)
801057b9:	89 74 24 0c          	mov    %esi,0xc(%esp)
801057bd:	89 44 24 08          	mov    %eax,0x8(%esp)
801057c1:	8b 43 30             	mov    0x30(%ebx),%eax
801057c4:	c7 04 24 30 76 10 80 	movl   $0x80107630,(%esp)
801057cb:	89 44 24 04          	mov    %eax,0x4(%esp)
801057cf:	e8 7c ae ff ff       	call   80100650 <cprintf>
      panic("trap");
801057d4:	c7 04 24 c6 75 10 80 	movl   $0x801075c6,(%esp)
801057db:	e8 80 ab ff ff       	call   80100360 <panic>
...
801058c7:	00 
  for(p="xv6...\n"; *p; p++)
801058c8:	bb 70 77 10 80       	mov    $0x80107770,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105918:	e9 f0 fa ff ff       	jmp    8010540d <alltraps>

8010591d <vector1>:
8010591d:	6a 00                	push   $0x0
8010591f:	6a 01                	push   $0x1
80105921:	e9 e7 fa ff ff       	jmp    8010540d <alltraps>
...
8010597c:	e9 8c fa ff ff       	jmp    8010540d <alltraps>
...
8010598a:	e9 7e fa ff ff       	jmp    8010540d <alltraps>
...
801059b5:	e9 53 fa ff ff       	jmp    8010540d <alltraps>

801059ba <vector20>:
801059ba:	6a 00                	push   $0x0
801059bc:	6a 14                	push   $0x14
801059be:	e9 4a fa ff ff       	jmp    8010540d <alltraps>

801059c3 <vector21>:
801059c3:	6a 00                	push   $0x0
801059c5:	6a 15                	push   $0x15
801059c7:	e9 41 fa ff ff       	jmp    8010540d <alltraps>

801059cc <vector22>:
801059cc:	6a 00                	push   $0x0
801059ce:	6a 16                	push   $0x16
801059d0:	e9 38 fa ff ff       	jmp    8010540d <alltraps>

801059d5 <vector23>:
801059d5:	6a 00                	push   $0x0
801059d7:	6a 17                	push   $0x17
801059d9:	e9 2f fa ff ff       	jmp    8010540d <alltraps>

801059de <vector24>:
801059de:	6a 00                	push   $0x0
801059e0:	6a 18                	push   $0x18
801059e2:	e9 26 fa ff ff       	jmp    8010540d <alltraps>

801059e7 <vector25>:
801059e7:	6a 00                	push   $0x0
801059e9:	6a 19                	push   $0x19
801059eb:	e9 1d fa ff ff       	jmp    8010540d <alltraps>

801059f0 <vector26>:
801059f0:	6a 00                	push   $0x0
801059f2:	6a 1a                	push   $0x1a
801059f4:	e9 14 fa ff ff       	jmp    8010540d <alltraps>

801059f9 <vector27>:
801059f9:	6a 00                	push   $0x0
801059fb:	6a 1b                	push   $0x1b
801059fd:	e9 0b fa ff ff       	jmp    8010540d <alltraps>

80105a02 <vector28>:
80105a02:	6a 00                	push   $0x0
80105a04:	6a 1c                	push   $0x1c
80105a06:	e9 02 fa ff ff       	jmp    8010540d <alltraps>

80105a0b <vector29>:
80105a0b:	6a 00                	push   $0x0
80105a0d:	6a 1d                	push   $0x1d
80105a0f:	e9 f9 f9 ff ff       	jmp    8010540d <alltraps>

80105a14 <vector30>:
80105a14:	6a 00                	push   $0x0
80105a16:	6a 1e                	push   $0x1e
80105a18:	e9 f0 f9 ff ff       	jmp    8010540d <alltraps>

80105a1d <vector31>:
80105a1d:	6a 00                	push   $0x0
80105a1f:	6a 1f                	push   $0x1f
80105a21:	e9 e7 f9 ff ff       	jmp    8010540d <alltraps>

80105a26 <vector32>:
80105a26:	6a 00                	push   $0x0
80105a28:	6a 20                	push   $0x20
80105a2a:	e9 de f9 ff ff       	jmp    8010540d <alltraps>
...
80105d42:	e9 c6 f6 ff ff       	jmp    8010540d <alltraps>

80105d47 <vector121>:
80105d47:	6a 00                	push   $0x0
80105d49:	6a 79                	push   $0x79
80105d4b:	e9 bd f6 ff ff       	jmp    8010540d <alltraps>

80105d50 <vector122>:
80105d50:	6a 00                	push   $0x0
80105d52:	6a 7a                	push   $0x7a
80105d54:	e9 b4 f6 ff ff       	jmp    8010540d <alltraps>
...
80105d66:	e9 a2 f6 ff ff       	jmp    8010540d <alltraps>

80105d6b <vector125>:
80105d6b:	6a 00                	push   $0x0
80105d6d:	6a 7d                	push   $0x7d
80105d6f:	e9 99 f6 ff ff       	jmp    8010540d <alltraps>

80105d74 <vector126>:
80105d74:	6a 00                	push   $0x0
80105d76:	6a 7e                	push   $0x7e
80105d78:	e9 90 f6 ff ff       	jmp    8010540d <alltraps>
...
801063f2:	e8 79 de ff ff       	call   80104270 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
801064aa:	c3                   	ret    
        panic("kfree");
801064ab:	c7 04 24 86 70 10 80 	movl   $0x80107086,(%esp)
...
801065f1:	c3                   	ret    
      panic("remap");
801065f2:	c7 04 24 78 77 10 80 	movl   $0x80107778,(%esp)
...
80106644:	0f 84 c3 00 00 00    	je     8010670d <switchuvm+0xed>
  pushcli();
8010664a:	e8 a1 da ff ff       	call   801040f0 <pushcli>
...
801066fb:	5d                   	pop    %ebp
  popcli();
801066fc:	e9 af da ff ff       	jmp    801041b0 <popcli>
    panic("switchuvm: no process");
80106701:	c7 04 24 7e 77 10 80 	movl   $0x8010777e,(%esp)
80106708:	e8 53 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no pgdir");
8010670d:	c7 04 24 a9 77 10 80 	movl   $0x801077a9,(%esp)
80106714:	e8 47 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no kstack");
80106719:	c7 04 24 94 77 10 80 	movl   $0x80107794,(%esp)
...
80106765:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
80106767:	e8 04 db ff ff       	call   80104270 <memset>
...
801067a8:	5d                   	pop    %ebp
  memmove(mem, init, sz);
801067a9:	e9 62 db ff ff       	jmp    80104310 <memmove>
    panic("inituvm: more than a page");
801067ae:	c7 04 24 bd 77 10 80 	movl   $0x801077bd,(%esp)
...
80106862:	c7 04 24 d7 77 10 80 	movl   $0x801077d7,(%esp)
80106869:	e8 f2 9a ff ff       	call   80100360 <panic>
    panic("loaduvm: addr must be page aligned");
8010686e:	c7 04 24 78 78 10 80 	movl   $0x80107878,(%esp)
...
801068cb:	e8 a0 d9 ff ff       	call   80104270 <memset>
...
80106912:	c7 04 24 f5 77 10 80 	movl   $0x801077f5,(%esp)
...
80106940:	c7 04 24 0d 78 10 80 	movl   $0x8010780d,(%esp)
...
80106a03:	e9 d8 b8 ff ff       	jmp    801022e0 <kfree>
    panic("freevm: no pgdir");
80106a08:	c7 04 24 29 78 10 80 	movl   $0x80107829,(%esp)
...
80106a4b:	e8 20 d8 ff ff       	call   80104270 <memset>
...
80106aeb:	c3                   	ret    
    panic("clearpteu");
80106aec:	c7 04 24 3a 78 10 80 	movl   $0x8010783a,(%esp)
...
80106b06:	83 ec 2c             	sub    $0x2c,%esp
  struct proc *curproc = myproc();
80106b09:	e8 82 cb ff ff       	call   80103690 <myproc>
80106b0e:	89 45 dc             	mov    %eax,-0x24(%ebp)
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if ((d = setupkvm()) == 0)
80106b11:	e8 0a ff ff ff       	call   80106a20 <setupkvm>
80106b16:	85 c0                	test   %eax,%eax
80106b18:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106b1b:	0f 84 8d 01 00 00    	je     80106cae <copyuvm+0x1ae>
    return 0;
  for (i = 0; i < sz; i += PGSIZE)
80106b21:	8b 45 0c             	mov    0xc(%ebp),%eax
80106b24:	85 c0                	test   %eax,%eax
80106b26:	0f 84 ac 00 00 00    	je     80106bd8 <copyuvm+0xd8>
80106b2c:	31 db                	xor    %ebx,%ebx
80106b2e:	eb 51                	jmp    80106b81 <copyuvm+0x81>
...
80106b30:	81 c7 00 00 00 80    	add    $0x80000000,%edi
80106b36:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106b3d:	00 
80106b3e:	89 7c 24 04          	mov    %edi,0x4(%esp)
80106b42:	89 04 24             	mov    %eax,(%esp)
80106b45:	e8 c6 d7 ff ff       	call   80104310 <memmove>
    if (mappages(d, (void *)i, PGSIZE, V2P(mem), flags) < 0)
80106b4a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106b4d:	8d 96 00 00 00 80    	lea    -0x80000000(%esi),%edx
80106b53:	89 54 24 0c          	mov    %edx,0xc(%esp)
80106b57:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106b5e:	00 
80106b5f:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80106b63:	89 44 24 10          	mov    %eax,0x10(%esp)
80106b67:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106b6a:	89 04 24             	mov    %eax,(%esp)
80106b6d:	e8 0e fa ff ff       	call   80106580 <mappages>
80106b72:	85 c0                	test   %eax,%eax
80106b74:	78 4d                	js     80106bc3 <copyuvm+0xc3>
  for (i = 0; i < sz; i += PGSIZE)
80106b76:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106b7c:	39 5d 0c             	cmp    %ebx,0xc(%ebp)
80106b7f:	76 57                	jbe    80106bd8 <copyuvm+0xd8>
    if ((pte = walkpgdir(pgdir, (void *)i, 0)) == 0)
80106b81:	8b 45 08             	mov    0x8(%ebp),%eax
80106b84:	31 c9                	xor    %ecx,%ecx
80106b86:	89 da                	mov    %ebx,%edx
80106b88:	e8 03 f8 ff ff       	call   80106390 <walkpgdir>
80106b8d:	85 c0                	test   %eax,%eax
80106b8f:	0f 84 2c 01 00 00    	je     80106cc1 <copyuvm+0x1c1>
    if (!(*pte & PTE_P))
80106b95:	8b 30                	mov    (%eax),%esi
80106b97:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106b9d:	0f 84 12 01 00 00    	je     80106cb5 <copyuvm+0x1b5>
    pa = PTE_ADDR(*pte);
...
80106bae:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if ((mem = kalloc()) == 0)
80106bb4:	e8 d7 b8 ff ff       	call   80102490 <kalloc>
80106bb9:	85 c0                	test   %eax,%eax
80106bbb:	89 c6                	mov    %eax,%esi
80106bbd:	0f 85 6d ff ff ff    	jne    80106b30 <copyuvm+0x30>
  }
...
80106bc9:	e8 d2 fd ff ff       	call   801069a0 <freevm>
  return 0;
...
80106bdb:	8b 40 7c             	mov    0x7c(%eax),%eax
80106bde:	f7 d8                	neg    %eax
80106be0:	c1 e0 0c             	shl    $0xc,%eax
80106be3:	05 00 f0 ff 7f       	add    $0x7ffff000,%eax
80106be8:	3d ff ef ff 7f       	cmp    $0x7fffefff,%eax
80106bed:	0f 87 b0 00 00 00    	ja     80106ca3 <copyuvm+0x1a3>
80106bf3:	bb 00 f0 ff 7f       	mov    $0x7ffff000,%ebx
80106bf8:	eb 6a                	jmp    80106c64 <copyuvm+0x164>
80106bfa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    memmove(mem, (char *)P2V(pa), PGSIZE);
80106c00:	81 c7 00 00 00 80    	add    $0x80000000,%edi
80106c06:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106c0d:	00 
80106c0e:	89 7c 24 04          	mov    %edi,0x4(%esp)
80106c12:	89 04 24             	mov    %eax,(%esp)
80106c15:	e8 f6 d6 ff ff       	call   80104310 <memmove>
    if (mappages(d, (void *)i, PGSIZE, V2P(mem), flags) < 0)
80106c1a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106c1d:	8d 96 00 00 00 80    	lea    -0x80000000(%esi),%edx
80106c23:	89 54 24 0c          	mov    %edx,0xc(%esp)
80106c27:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106c2e:	00 
80106c2f:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80106c33:	89 44 24 10          	mov    %eax,0x10(%esp)
80106c37:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106c3a:	89 04 24             	mov    %eax,(%esp)
80106c3d:	e8 3e f9 ff ff       	call   80106580 <mappages>
80106c42:	85 c0                	test   %eax,%eax
80106c44:	0f 88 79 ff ff ff    	js     80106bc3 <copyuvm+0xc3>
  for (i = PGROUNDDOWN(KERNBASE - 1); i > PGROUNDDOWN(KERNBASE - 1) - (curproc->pages) * PGSIZE; i -= PGSIZE)
80106c4a:	8b 45 dc             	mov    -0x24(%ebp),%eax
80106c4d:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
80106c53:	8b 40 7c             	mov    0x7c(%eax),%eax
80106c56:	f7 d8                	neg    %eax
80106c58:	c1 e0 0c             	shl    $0xc,%eax
80106c5b:	05 00 f0 ff 7f       	add    $0x7ffff000,%eax
80106c60:	39 d8                	cmp    %ebx,%eax
80106c62:	73 3f                	jae    80106ca3 <copyuvm+0x1a3>
    if ((pte = walkpgdir(pgdir, (void *)i, 0)) == 0)
80106c64:	8b 45 08             	mov    0x8(%ebp),%eax
80106c67:	31 c9                	xor    %ecx,%ecx
80106c69:	89 da                	mov    %ebx,%edx
80106c6b:	e8 20 f7 ff ff       	call   80106390 <walkpgdir>
80106c70:	85 c0                	test   %eax,%eax
80106c72:	74 4d                	je     80106cc1 <copyuvm+0x1c1>
    if (!(*pte & PTE_P))
80106c74:	8b 30                	mov    (%eax),%esi
80106c76:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106c7c:	74 37                	je     80106cb5 <copyuvm+0x1b5>
    pa = PTE_ADDR(*pte);
80106c7e:	89 f7                	mov    %esi,%edi
    flags = PTE_FLAGS(*pte);
80106c80:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80106c86:	89 75 e4             	mov    %esi,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80106c89:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if ((mem = kalloc()) == 0)
80106c8f:	e8 fc b7 ff ff       	call   80102490 <kalloc>
80106c94:	85 c0                	test   %eax,%eax
80106c96:	89 c6                	mov    %eax,%esi
80106c98:	0f 85 62 ff ff ff    	jne    80106c00 <copyuvm+0x100>
80106c9e:	e9 20 ff ff ff       	jmp    80106bc3 <copyuvm+0xc3>
80106ca3:	8b 45 e0             	mov    -0x20(%ebp),%eax
}
80106ca6:	83 c4 2c             	add    $0x2c,%esp
80106ca9:	5b                   	pop    %ebx
80106caa:	5e                   	pop    %esi
80106cab:	5f                   	pop    %edi
80106cac:	5d                   	pop    %ebp
80106cad:	c3                   	ret    
    return 0;
80106cae:	31 c0                	xor    %eax,%eax
80106cb0:	e9 1b ff ff ff       	jmp    80106bd0 <copyuvm+0xd0>
      panic("copyuvm: page not present");
80106cb5:	c7 04 24 5e 78 10 80 	movl   $0x8010785e,(%esp)
80106cbc:	e8 9f 96 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106cc1:	c7 04 24 44 78 10 80 	movl   $0x80107844,(%esp)
...
80106cde:	e8 ad f6 ff ff       	call   80106390 <walkpgdir>
  if ((*pte & PTE_P) == 0)
...
80106d4c:	e8 bf d5 ff ff       	call   80104310 <memmove>
    len -= n;
    buf += n;
...
80106da6:	c7 44 24 04 9c 78 10 	movl   $0x8010789c,0x4(%esp)
80106dad:	80 
80106dae:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106db5:	e8 86 d2 ff ff       	call   80104040 <initlock>
  acquire(&(shm_table.lock));
80106dba:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106dc1:	e8 6a d3 ff ff       	call   80104130 <acquire>
...
80106df5:	e8 26 d4 ff ff       	call   80104220 <release>
}
80106dfa:	c9                   	leave  
80106dfb:	c3                   	ret    
